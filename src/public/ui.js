...
//Este archivo contiene funciones que van a interactuar con la interfaz de usuario.
...
export const renderNotes = (notes) => {
    savedId = "";
    notesList.innerHTML = "";
    notes.forEach((note) => notesList.append(noteUI(note))); //append no innerHTML, porque estamos añadiendo un elemento.
};
